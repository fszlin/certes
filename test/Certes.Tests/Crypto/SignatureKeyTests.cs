...
namespace Certes.Crypto
{
    public class SignatureKeyTests
    {
        ...
        private void EnsurePropertySerializationOrder()
        {
            ...
            var k = KeyFactory.FromPem(Keys.ES256Key_Alt1);
            var ecKey = (EcJsonWebKey)k.JsonWebKey;
            var ecKeyJson = System.Text.Json.JsonSerializer.Serialize(ecKey, JsonUtil.CreateSettings());
            ...
            var rsaKeyJson = System.Text.Json.JsonSerializer.Serialize(rsaKey, JsonUtil.CreateSettings());
